...
```shell
npm install poeditor-htmid --save-dev
```

Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:

```js
grunt.loadNpmTasks('poeditor-htmid');
```

## The "poeditor_htmid" task

### Overview
In your project's Gruntfile, add a section named `poeditor_htmid` to the data object passed into `grunt.initConfig()`.
